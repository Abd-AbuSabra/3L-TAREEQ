...
class GeminiPage2 extends StatefulWidget {
  const GeminiPage2({super.key});

  @override
  State<GeminiPage2> createState() => _GeminiPage2State();
}

class _GeminiPage2State extends State<GeminiPage2> {
