...
void main() async {
  ...
  // Initialize Firebase and catch initialization errors
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: FirebaseAuth.instance.currentUser != null
          ? user_dashboard() // User is signed in, show the dashboard
          : Login(), // User is not signed in, show the sign-in page
    );
  }
}
